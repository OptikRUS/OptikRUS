...
**Стек:** 
Python3 (OpenCV, PyQt6, SQLAlchemy, pyinstaller), SQLite, Docker, GitHub, Trello
---
...
**Стек:**  
Python3 (FastAPI, Django DRF), PostgreSQL, MongoDB, Docker, S3 (Amazon, MinIO), GitHub, Trello
---
...
**Стек:** 
Python (aiogram, Django), PostgreSQL, Docker, Trello, GitHub
---
...
**Стек:** 
Python (FastAPI, Motor), MongoDB, Kafka, Notion, GitHub
---
...
**Стек:** 
Python (Django DRF), PostgreSQL, Docker, GitHub, Trello
---
...
**Стек:** 
Python (Django), PostgreSQL, Docker, GitHub, Trello
***
## 🛠 Ключевые навыки:
